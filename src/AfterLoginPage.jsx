    ...
    return(
        <Container>
            ...
            <Wrapper>
                ...
                <Contents>
                    <ModifyBook>
                        <Link to='/' style={{width: "300px", textDecoration: "none", textDecorationColor: "black", backgroundColor: "lightgray", color: "black", display: "flex", justifyContent: "center"}}>Modify Book Details</Link>
                    </ModifyBook>
                    <Profile>
                        <Link to='/' style={{width: "300px", textDecoration: "none", textDecorationColor: "black", backgroundColor: "lightgray", color: "black", display: "flex", justifyContent: "center"}}>Profile</Link>
                    </Profile>
                </Contents>
            </Wrapper>
